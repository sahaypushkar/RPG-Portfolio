export const textNodes = [
    ...
    },
    {
      ...
      text: "As you hover over the 'start adventure' button, a twinge of apprehension courses through you. It's an uncharted territory, deviating from the norm.",
    ...
    // New nodes
    {
      ...
      text: "The AI takes you on a journey through the developer's skill set. From HTML/CSS basics, to Javascript's asynchronous behavior, React's virtual DOM, Tailwind's Magic and Redux's state management",
    ...
    },
    {
      ...
      text: "The AI starts with the basics, highlighting the developer's understanding of HTML and CSS. You see artifacts of responsive design, flexbox layout, semantic HTML, and CSS Grid along with the use of CSS preprocessors.",
      img: "./assets/html.jpg",
      options: [
        {
    ...
    },
    {
      ...
      text: "Lastly, the AI reveals the developer's past projects & experiences. You see visually stunning & intriguing web apps with secure authentication, and cross platform adaptability.",
      img: "./assets/node.jpg",
      options: [
        {
    ...
    },
    {
      ...
      text: "You near the adventure's climax, a challenge that hints at the developer's knowledge of cutting-edge technologies like React, Tailwind, or SwiperJs.",
      img: "./assets/cave.jpg",
      options: [
        {
    ...
    },
    {
      ...
      text: "At the crux of the adventure, you encounter a complex challenge that requires a nuanced understanding of front-end development. The solution to this challenge is a testament to the developer's competency.",
      ...
      options: [
        {
          ...
          linkUrl: "https://www.linkedin.com/in/pushkarsahay", // replace with actual LinkedIn URL
        },
        {
